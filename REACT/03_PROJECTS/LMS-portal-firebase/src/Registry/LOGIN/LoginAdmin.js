            ...
            <Container
                ...
                <div className="w-100" style={{ maxWidth: "400px" }}>
                    ...
                    <Card className="border border-secondary shadow">
                        <Card.Body>
                            <div className="text-center">
                                <i className="fa fa-sign-in fa-2x center" aria-hidden="true"></i>
                        ...
                        <div className="d-grid gap-2 mt-3">
                            ...
                            <div className="w-100 text-center mt-3">
                                <Link to="/reset-admin"><strong>Forgot Password ?</strong></Link>
                            </div>
                    ...
                    {/* <div className="p-4 text-center">
                        Don't have an account? <Link to="/signup-admin"><strong>Sign Up</strong></Link>
                    </div> */}
