          ...
          <Card className="border border-secondary shadow">
            <Card.Body>
              <div className="text-center">
                ...
                <h2 className="mb-4">Teacher Password Reset</h2>
              </div>
              ...
              <div className="w-100 text-center mt-3">
                <Link to="/login-teacher"><strong>Login</strong></Link>
              </div>
            </Card.Body>
          </Card>
          {/* <div className="w-100 text-center mt-2 p-4">
            Need an account? <Link to="/signup-teacher"><strong>Sign Up</strong></Link>
          </div> */}
