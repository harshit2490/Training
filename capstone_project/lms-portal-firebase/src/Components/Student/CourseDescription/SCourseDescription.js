...
import SCourseDescriptionComponent from './SCourseDescriptionComponent';

function SCourseDescription() {
            ...
            <div className='main-container d-flex'>
                ...
                <div className='content'>
                    <section className='text-center justify-content-center '>
                        {/*--------------(Students Each Course Description Component)--------------*/}
                        <SCourseDescriptionComponent />
                    </section>
                </div>
            </div>
        </>
...
export default SCourseDescription;